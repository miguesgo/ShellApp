...
public class tortugaAligator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tortuga_aligator);
        ...
        userConfiguracion.setOnClickListener(view -> {
            startActivity(new Intent(tortugaAligator.this, Configuracion.class));
        });

        userButtonUser.setOnClickListener(view -> {
            startActivity(new Intent(tortugaAligator.this, User.class));
        });

        userButtonHome.setOnClickListener(view -> {
            startActivity(new Intent(tortugaAligator.this, Wiki.class));
        });

        userButtonEdit.setOnClickListener(view -> {
            startActivity(new Intent(tortugaAligator.this, Edit.class));
        });

        userButtonBuscar.setOnClickListener(view -> {
            startActivity(new Intent(tortugaAligator.this, Search.class));
        });

        DocumentReference docRef = firebaseFirestore.collection("tortugasDulce").
                document("tortugaAligator");
