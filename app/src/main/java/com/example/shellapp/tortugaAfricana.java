...
public class tortugaAfricana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tortuga_africana);
        ...
        userConfiguracion.setOnClickListener(view -> {
            startActivity(new Intent(tortugaAfricana.this, Configuracion.class));
        });

        userButtonUser.setOnClickListener(view -> {
            startActivity(new Intent(tortugaAfricana.this, User.class));
        });

        userButtonHome.setOnClickListener(view -> {
            startActivity(new Intent(tortugaAfricana.this, Wiki.class));
        });

        userButtonEdit.setOnClickListener(view -> {
            startActivity(new Intent(tortugaAfricana.this, Edit.class));
        });

        userButtonBuscar.setOnClickListener(view -> {
            startActivity(new Intent(tortugaAfricana.this, Search.class));
        });

        DocumentReference docRef = firebaseFirestore.collection("tortugaTierra").
                document("tortugaAfricana");
