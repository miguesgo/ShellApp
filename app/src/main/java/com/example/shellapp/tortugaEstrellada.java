...
public class tortugaEstrellada extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tortuga_estrellada);
        ...
        userConfiguracion.setOnClickListener(view -> {
            startActivity(new Intent(tortugaEstrellada.this, Configuracion.class));
        });

        userButtonUser.setOnClickListener(view -> {
            startActivity(new Intent(tortugaEstrellada.this, User.class));
        });

        userButtonHome.setOnClickListener(view -> {
            startActivity(new Intent(tortugaEstrellada.this, Wiki.class));
        });

        userButtonEdit.setOnClickListener(view -> {
            startActivity(new Intent(tortugaEstrellada.this, Edit.class));
        });

        userButtonBuscar.setOnClickListener(view -> {
            startActivity(new Intent(tortugaEstrellada.this, Search.class));
        });

        DocumentReference docRef = firebaseFirestore.collection("tortugaTierra").
                document("tortugaEstrellada");
