...
public class RioTortugaPintada extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rio_tortuga_pintada);
        ...
        userConfiguracion.setOnClickListener(view -> {
            startActivity(new Intent(RioTortugaPintada.this, Configuracion.class));
        });

        userButtonUser.setOnClickListener(view -> {
            startActivity(new Intent(RioTortugaPintada.this, User.class));
        });

        userButtonHome.setOnClickListener(view -> {
            startActivity(new Intent(RioTortugaPintada.this, Wiki.class));
        });

        userButtonEdit.setOnClickListener(view -> {
            startActivity(new Intent(RioTortugaPintada.this, Edit.class));
        });

        userButtonBuscar.setOnClickListener(view -> {
            startActivity(new Intent(RioTortugaPintada.this, Search.class));
        });

        DocumentReference docRef = firebaseFirestore.collection("tortugasDulce").
                document("TortugaPintada");
