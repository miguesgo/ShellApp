...
public class TortugasRio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tortugas_rio);
        ...
        userConfiguracion.setOnClickListener(view -> {
            startActivity(new Intent(TortugasRio.this, Configuracion.class));
        });

        userButtonUser.setOnClickListener(view -> {
            startActivity(new Intent(TortugasRio.this, User.class));
        });

        userButtonHome.setOnClickListener(view -> {
            startActivity(new Intent(TortugasRio.this, Wiki.class));
        });

        userButtonBuscar.setOnClickListener(view -> {
            startActivity(new Intent(TortugasRio.this, Search.class));
        });

        userButtonEdit.setOnClickListener(view -> {
            startActivity(new Intent(TortugasRio.this, Edit.class));
        });

        DocumentReference docRef = firebaseFirestore.collection("tortugasDulce").
                document("BuDbqvoo2jQfpF0QkasL");
        ...
        /*
        firebaseFirestore.collection("tortugasDulce")
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if(task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                if(document.getDocumentReference("/tortugasDulce/BuDbqvoo2jQfpF0QkasL")) {
                                    wikiTituloPrincipal.setText(document.getString("Nombre"));
                                    wikiAcercaDe.setText(document.getString("Especie"));
                                    wikiDescripcion.setText(document.getString("Descripcion"));
