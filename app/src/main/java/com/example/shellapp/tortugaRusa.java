...
public class tortugaRusa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tortuga_rusa);
        ...
        userConfiguracion.setOnClickListener(view -> {
            startActivity(new Intent(tortugaRusa.this, Configuracion.class));
        });

        userButtonUser.setOnClickListener(view -> {
            startActivity(new Intent(tortugaRusa.this, User.class));
        });

        userButtonHome.setOnClickListener(view -> {
            startActivity(new Intent(tortugaRusa.this, Wiki.class));
        });

        userButtonEdit.setOnClickListener(view -> {
            startActivity(new Intent(tortugaRusa.this, Edit.class));
        });

        userButtonBuscar.setOnClickListener(view -> {
            startActivity(new Intent(tortugaRusa.this, Search.class));
        });

        DocumentReference docRef = firebaseFirestore.collection("tortugaTierra").
                document("tortugaRusa");
