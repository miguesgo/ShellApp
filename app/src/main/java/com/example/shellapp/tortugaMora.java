...
public class tortugaMora extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tortuga_mora);
        ...
        userConfiguracion.setOnClickListener(view -> {
            startActivity(new Intent(tortugaMora.this, Configuracion.class));
        });

        userButtonUser.setOnClickListener(view -> {
            startActivity(new Intent(tortugaMora.this, User.class));
        });

        userButtonHome.setOnClickListener(view -> {
            startActivity(new Intent(tortugaMora.this, Wiki.class));
        });

        userButtonBuscar.setOnClickListener(view -> {
            startActivity(new Intent(tortugaMora.this, Search.class));
        });

        userButtonEdit.setOnClickListener(view -> {
            startActivity(new Intent(tortugaMora.this, Edit.class));
        });

        DocumentReference docRef = firebaseFirestore.collection("tortugaTierra").
                document("tortugaMora");
